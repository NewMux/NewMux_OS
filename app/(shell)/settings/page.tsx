...
export default async function SettingsPage() {
  ...
  const [parties, deductionTypes, rules, projects, ventures] =
    await Promise.all([
      listParties(),
      listDeductionTypes(),
      listProfitSplitRules(),
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mb-4 text-xs text-muted-foreground">
        Admin-only. Every change here is timestamped and attributed in the audit
        log.
      </p>
        ...
        <Card>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <p className="text-xs text-muted-foreground">
              Saved on this device. &ldquo;System&rdquo; follows your operating
              system setting.
            </p>
